...
/* evaluation of 4 sines at onces, using only SSE1+MMX intrinsics so
   ...
   deliver full speed.
*/
static v4sf __attribute__((unused)) sin_ps(v4sf x){ // any x
...
static v4sf __attribute__((unused)) cos_ps(v4sf x) { // any x
...
static void __attribute__((unused)) sincos_ps(v4sf x, v4sf *s, v4sf *c) {
